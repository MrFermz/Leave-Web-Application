...
function onChange() {
    ...
    // let sumaryScope     =       `${dateStart[0].value} - ${dateEnd[0].value}`
    // let sumaryDays      =       dateEnd[0].value - dateStart[0].value
    ...
    // document.getElementById('sumary-scope').innerHTML   =   sumaryScope
    // document.getElementById('sumary-days').innerHTML    =   sumaryDays
